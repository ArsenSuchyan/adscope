(() => {
    ...
    function initSliders() {
        if (document.querySelector(".for-whom__slider")) new swiper_core_Swiper(".for-whom__slider", {
    ...
    document.querySelector(".about-us__container"), document.querySelector(".mission__container"), 
    document.querySelector(".solutions__container"), document.querySelector(".value__container"), 
    document.querySelector(".for-whom__container"), document.querySelector(".partners__container"), 
    document.querySelector(".next-step__container");
